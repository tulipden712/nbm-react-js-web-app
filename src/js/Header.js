				...
				<div className="container">
					<div className="row">
						<div className="site-branding col-5 d-flex align-items-center">
							<a href="https://www.axonactive.com/" className="custom-logo-link" rel="home" itemprop="url">
								<img src="https://newaxonactive-6113.kxcdn.com/wp-content/themes/axon-v3/images/logo.svg" className="custom-logo" alt="" itemprop="logo" />
							</a>
